...
async function startNewChat() {
    ...
    // If there was an existing session, clear it on the backend
    // (We just reset currentSessionId to null, so the next query will create a new session automatically)
}
