...
class RAGSystem:
    ...
    def __init__(self, config):
        ...
        self.ai_generator = AIGenerator(config.BIGMODEL_API_KEY, config.BIGMODEL_MODEL)
    ...
    def query(
        ...
        Returns:
            Tuple of (response, sources list with structured objects containing text and optional url)  # noqa: E501
        """
